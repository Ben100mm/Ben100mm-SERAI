    ...
    return (
      <div className="min-h-screen bg-white flex items-center justify-center">
        <div className="text-center">
          <div className="animate-spin rounded-full h-12 w-12 border-b-2 border-serai-serai-serai-red-500 mx-auto"></div>
          <p className="mt-4 text-serai-neutral-500">Loading...</p>
        </div>
      </div>
    );
  }
