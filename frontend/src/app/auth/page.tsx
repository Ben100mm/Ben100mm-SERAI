...
export default function AuthPage() {
  const { login, register, socialLogin, isLoading, isAuthenticated } = useAuth();
          ...
          <div className="mb-8">
            ...
            <form onSubmit={isLogin ? handleEmailLogin : handleEmailRegister} className="space-y-4">
              ...
              <button
                type="submit"
                disabled={isLoading}
                className="w-full bg-gradient-to-r from-red-800 to-red-900 text-white font-semibold py-3 rounded-lg hover:from-red-900 hover:to-red-950 transition-all duration-300 hover:scale-105 shadow-lg disabled:opacity-50 disabled:cursor-not-allowed"
              >
            ...
            <div className="flex justify-center space-x-4">
              ...
              <button 
                ...
                disabled={isLoading}
                className="w-12 h-12 flex items-center justify-center border border-gray-300 rounded-full hover:bg-gray-50 transition-colors duration-200 disabled:opacity-50 disabled:cursor-not-allowed"
              >
