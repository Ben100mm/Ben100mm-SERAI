...
export default function LoginSignupPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // Redirect to confirm number page
      router.push('/auth/confirm-number?phone=' + encodeURIComponent(selectedCountryData?.code + phoneNumber));
    } catch (error) {
          ...
          <div className="bg-white rounded-2xl shadow-lg border border-gray-200 p-8">
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div>
                ...
                <div className="relative">
                  <select
                    id="country"
                    className="w-full px-4 py-3 pr-10 border border-gray-300 rounded-lg focus:ring-2 focus:ring-red-500 focus:border-transparent appearance-none bg-white cursor-pointer z-20 relative text-gray-700"
              ...
              <div>
                ...
                <div className="flex">
                  <div className="flex items-center px-3 py-3 border border-r-0 border-gray-300 rounded-l-lg bg-gray-100 text-gray-700 font-medium">
              ...
              <button
                ...
                style={{ backgroundColor: '#660f0f' }}
                onMouseEnter={(e) => e.target.style.backgroundColor = '#550c0c'}
                onMouseLeave={(e) => e.target.style.backgroundColor = '#660f0f'}
              >
                Continue
              </button>
            </form>
            ...
            <div className="mt-8">
              ...
              <div className="mt-6 flex justify-center space-x-4">
                {/* Google */}
                <button className="w-12 h-12 rounded-full border border-gray-300 shadow-sm bg-white hover:bg-gray-100 flex items-center justify-center">
