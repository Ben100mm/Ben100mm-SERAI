...
const mockConversations: Conversation[] = [
  {
    id: '1',
    guestName: 'Emma Thompson, Serai Luxury Suites',
  ...
  {
    id: '2',
    guestName: 'James Rodriguez, Boutique Hotel Collection',
  ...
  {
    id: '3',
    guestName: 'Sophie Chen, Urban Retreat Properties',
  ...
  {
    id: '4',
    guestName: 'David Kim, Luxury Hospitality Group',
  ...
  {
    id: '5',
    guestName: 'Isabella Martinez, Premium Stays Inc',
  ...
  {
    id: '6',
    guestName: 'Alexander Petrov, Elite Accommodations',
  ...
  {
    id: '7',
    guestName: 'Olivia Williams, Boutique Collection',
  ...
  {
    id: '8',
    guestName: 'Marcus Johnson, Urban Luxury Hotels',
  ...
  {
    id: '9',
    guestName: 'Charlotte Brown, Serai Hospitality',
  ...
  {
    id: '10',
    guestName: 'Ryan O\'Connor, Premium Properties Ltd',
...
const mockMessages: Message[] = [
  {
    id: '1',
    content: 'Hi Emma! Welcome to Serai Luxury Suites. I\'m thrilled to host you for your upcoming stay. I\'ve prepared everything for your arrival tomorrow.',
    sender: 'host',
  ...
  {
    id: '2',
    content: 'Thank you so much! I\'m really excited about staying in the penthouse suite. I saw the photos and the city views look absolutely stunning. I\'m arriving around 3 PM tomorrow - is that a good time for check-in?',
    sender: 'guest',
  ...
  {
    id: '3',
    content: 'Perfect timing! Check-in is from 3 PM onwards, so you\'ll be right on time. I\'ll have the keys ready for you at the front desk. The penthouse suite is on the 25th floor with panoramic views of the entire city skyline.',
    sender: 'host',
  ...
  {
    id: '11',
    content: 'You\'re very welcome, Emma! I\'m here to make sure your stay is absolutely perfect. If you need anything at all during your visit, just reach out. I\'ll be checking in with you tomorrow after you arrive to make sure everything is to your satisfaction. Have a safe trip!',
    sender: 'host',
  ...
  },
  {
    ...
    sender: 'guest',
    timestamp: 'December 14, 2024 6:20 PM',
    isRead: true
  }
];
                ...
                >
                  ...
                  >
                    ...
                    <p className={`text-xs mt-1 ${
                      message.sender === 'host' ? 'text-serai-red-100' : 'text-serai-neutral-500'
                    }`}>
                      {message.timestamp}
                    </p>
                  </div>
        ...
        {selectedConversation ? (
          <div>
            ...
            <div className="p-4 border-b border-serai-neutral-200 flex-shrink-0">
              ...
              <div className="space-y-2 text-sm">
                <div className="flex justify-between">
                  <span className="text-serai-neutral-600">300.00 x 2 nights:</span>
                  <span className="text-serai-charcoal-700">${guestDetails.paymentBreakdown.roomFee.toFixed(2)}</span>
                </div>
                <div className="flex justify-between">
                  <span className="text-serai-neutral-600">Guest service fee:</span>
                  <span className="text-serai-charcoal-700">${guestDetails.paymentBreakdown.serviceFee.toFixed(2)}</span>
                </div>
                <div className="flex justify-between">
                  <span className="text-serai-neutral-600">Occupancy taxes:</span>
                  <span className="text-serai-charcoal-700">$75.00</span>
                </div>
                <div className="flex justify-between">
                  <span className="text-serai-neutral-600">Property use taxes:</span>
                  <span className="text-serai-charcoal-700">$30.00</span>
                </div>
                <div className="flex justify-between font-semibold border-t border-serai-neutral-200 pt-2">
                  <span className="text-serai-charcoal-900">Total (CAD):</span>
                  <span className="text-serai-charcoal-900">${guestDetails.paymentBreakdown.total.toFixed(2)}</span>
                </div>
              </div>
            </div>
            ...
            <div className="p-4 border-b border-serai-neutral-200 flex-shrink-0">
              ...
              <div className="space-y-2 text-sm">
                <div className="flex justify-between">
                  <span className="text-serai-neutral-600">2-night room fee:</span>
                  <span className="text-serai-charcoal-700">${guestDetails.hostPayout.roomFee.toFixed(2)}</span>
                </div>
                <button className="text-serai-red-600 hover:text-serai-red-800 text-sm">
                  Show breakdowns
                </button>
                <div className="flex justify-between">
                  <span className="text-serai-neutral-600">Host service fee (3.0%):</span>
                  <span className="text-serai-charcoal-700">${guestDetails.hostPayout.serviceFee.toFixed(2)}</span>
                </div>
                <div className="flex justify-between">
                  <span className="text-serai-neutral-600">Property use taxes:</span>
                  <span className="text-serai-charcoal-700">${guestDetails.hostPayout.taxes.toFixed(2)}</span>
                </div>
                <div className="flex justify-between font-semibold border-t border-serai-neutral-200 pt-2">
                  <span className="text-serai-charcoal-900">Total (CAD):</span>
                  <span className="text-serai-charcoal-900">${guestDetails.hostPayout.total.toFixed(2)}</span>
                </div>
                <button className="text-serai-red-600 hover:text-serai-red-800 text-sm">
                  Transaction History
                </button>
            ...
            <div className="p-4 space-y-3 flex-shrink-0">
              <div className="bg-serai-navy-50 p-3 rounded">
                ...
                <p className="text-xs text-serai-navy-700 mb-2">
                  Protection for damage or special cleaning
                </p>
              ...
              <div className="text-xs text-serai-neutral-500 space-y-1">
                ...
                <p>Printing receipts and payout details</p>
